    ...
    <>
      ...
      <div>
        <IonRadioGroup onIonChange={ (e) => onSetMomento('dos', e.target.value) }>
          <IonList lines="full" className={`ion-no-padding ${styles.momentos}`}>
            <IonItem className={styles.momento}>
              ...
              Soy una persona que normalmente mantiene una actitud positiva y piensa que las
              cosas se van a resolver para mejor. Suelo entusiasmarme por las cosas y no me
              cuesta encontrar en qué ocuparme. Me gusta estar con gente y ayudar a otros a ser
              felices; me agrada compartir con ellos mi bienestar. (No siempre me siento
              fabulosamente bien, pero trato de que nadie se dé cuenta.) Sin embargo, mantener
              esta actitud positiva ha significado a veces dejar pasar demasiado tiempo sin
            ...
            <IonItem className={styles.momento}>
              ...
              Soy una persona que tiene fuertes sentimientos respecto a las cosas, la mayoría de
              la gente lo nota cuando me siento desgraciado por algo. Sé ser-reservado con los
              demás, pero soy más sensible de lo que dejo ver. Deseo saber a qué atenerme con
              los demás y con quiénes y con qué puedo contar; la mayoría de las personas tienen
              muy claro a qué atenerse conmigo. Cuando estoy alterado por algo deseo que los
              demás reaccionen y se emocionen tanto como yo. Conozco las reglas, pero no quiero
              que me digan lo que he de hacer. Quiero decidir por mí mismo.
            </IonItem>
            ...
            <IonItem className={styles.momento}>
              ...
              Tiendo a controlarme y a ser lógico, me desagrada hacer frente a los sentimientos.
        ...
        <IonGrid>
          <IonRow>
            <IonCol>
              <IonButton expand="block" onClick={() => onClearMomentos()}> Atrás </IonButton>
            </IonCol>
            <IonCol>
              <IonButton expand="block" onClick={send}> Finalizar </IonButton>
            </IonCol>
          </IonRow>
        </IonGrid>
