...
export const Premium = () => {
  return (
    <div className={`${styles["content"]}`}>
      ...
      <img alt="" className={`${styles["logo-header"]}`} src={Logo} />
      ...
      <IonList
        className={`${styles["ion-text-justify"]} ${styles["caracteristicas"]} ${styles["w-100"]}`}
      >
        <IonItem lines="none">
          <span slot="start" className="material-symbols-outlined">military_tech</span>
          <IonLabel className={`${styles["ion-text-left"]}`}>
        ...
        <IonItem lines="none">
          ...
          <IonLabel className={`${styles["ion-text-left"]}`}>S.O.S Emocional</IonLabel>
        </IonItem>
      </IonList>
    </div>
  );
