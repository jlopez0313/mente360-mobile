...
import { useHistory } from "react-router";
  ...
  export function ContactDetailModal({ contact, open, onOpenChange }: ContactDetailModalProps) {
    ...
    const handleCommunityClick = (communityId: string) => {
      onOpenChange(false);
      history.replace(`/comunidades/${communityId}`);
    };
              ...
              {contact.birthDate && (
                <div className="flex items-center gap-3 text-sm">
                  ...
                  <div>
                    ...
                    <p className="text-foreground">{formatDate(contact.birthDate)}</p>
                  </div>
                </div>
              )}
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          <div className="text-left">
                            ...
                            <p className="text-xs text-muted-foreground">
                              {community.channels.length} canales • {community.memberCount} miembros
                            </p>
                          </div>
                        </div>
