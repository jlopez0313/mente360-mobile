  ...
  return (
    <div className="flex-1 flex flex-col justify-between pt-2 pb-4">
      <div>
        ...
        {/* Recommended Card */}
        <div className="bg-card rounded-3xl p-4 border border-border/80 shadow-card flex gap-4 items-start mb-6">
      ...
      <div className="mt-auto pt-4 flex flex-col gap-3">
        ...
        <button
          onClick={onLater}
          type="button"
          className="text-xs text-muted-foreground hover:text-foreground font-medium py-1 text-center"
        >
          Más tarde
        </button>
      </div>
